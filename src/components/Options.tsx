      ...
      <Space direction="vertical">
        ...
        <Form.Item label="폰트 설정">
          <Select
            ...
            options={['나눔바른펜OTF', 'LINE Seed Sans KR', 'Noto Sans KR', 'Pretendard', 'IBM Plex Sans KR'].map((font) => ({
              value: font,
        ...
        <Form.Item label="타이틀 폰트 설정">
          <Select
            ...
            options={['나눔바른펜OTF', 'LINE Seed Sans KR', 'KoPub Dotum', 'Noto Sans KR', 'Pretendard', 'IBM Plex Sans KR'].map((font) => ({
              value: font,
              label: <span style={{ fontFamily: font }}>{font}</span>,
            }))}
          />
